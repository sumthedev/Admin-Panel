...
export default function Dasboard() {
  return (
    <>
      <div className="w-[79.028vw] h-[57.778vw]">
        <div className="w-[11.389vw] h-[12.500vw] absolute flex left-[490px] top-[100px] custom-shadow">
          ...
          <span className="w-[11.389vw] h-[12.500vw]  absolute top-[116px] opacity-60">
            <SmallChart />
          </span>
        </div>
        <div className="w-[11.389vw] h-[12.500vw]  absolute flex left-[299px] top-[100px] custom-shadow">
        ...
        <div className="w-[25.722vw] flex custom-shadow h-[160px] absolute top-[302px] left-[299px]">
        ...
        <div className="chart-div2 custom-shadow">
          <h1 className="event-posting  ">Event Posting</h1>
          <span className="text-2 w-[40px] h-[5px] absolute top-[40px] left-[19px]">
            2023 Total Events: 12.84k
          </span>

          <Chart />

          <div className="w-[47.772vw] h-[33.333vw]">
            <UserTable />
          </div>

          <div>
            <div
              className="w-[25.417vw] h-[31.944vw] custom-shadow absolute top-[395px] 
